...
BEGIN
  ...
  -- CODIGO DEL PROCESO
	...
	FOR V_REG IN ( SELECT IDW_PRODUCTOS,
						ID_PRESENTACION,
						PRESENTACION,
						TAMANIO,
						ID_PRODUCTO,
	...
	LOOP
		...
		IF V_REG.IDW_PRODUCTOS !='-1' THEN
			...
			SET --ID_PRESENTACION = V_REG.ID_PRESENTACION,
				PRESENTACION = V_REG.PRESENTACION,
...
--/************ SI NO EXISTE DIFERENCIAS SIGNIFICA QUE EXISTEN NUEVOS REGISTROS ***/
    ...
    SELECT SEQ_IDW_PROD.NEXTVAL IDW_PRODUCTOS,
			ID_PRESENTACION,
			PRESENTACION,
			TAMANIO,
			ID_PRODUCTO,
